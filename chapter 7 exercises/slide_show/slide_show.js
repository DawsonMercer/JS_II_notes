...
document.addEventListener("DOMContentLoaded", () => {
    ...
    $("#start").addEventListener("click", () => {
        // create an interval timer which is going to call the runSlideshow Method every 2 seconsd
        console.log("2 second timer started")
        $("#pause").removeAttribute("disabled");
        $("#start").disabled = "true";

        timer = setInterval(runSlideShow,2000);
       
        //add code to disable the start button and enable the pause button
